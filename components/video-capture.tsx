...
import { Video, Square, Download, RefreshCw, Upload, Play, Pause, Camera } from "lucide-react"
...
export function VideoCapture() {
  ...
  useEffect(() => {
    ...
    // Just set up cleanup for when component unmounts
    return () => {
      if (stream) {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Road Video Object Detection</CardTitle>
          <CardDescription>Record or upload videos to detect and track road objects</CardDescription>
        </CardHeader>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              {isProcessing ? (
                ...
                <div className="bg-muted rounded-lg p-6 h-full flex flex-col justify-center">
                    ...
                    {currentVideo ? (
                      <>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="h-24 bg-black/10 rounded flex items-center justify-center text-xs text-muted-foreground">
                            Before/after comparison will appear here
                          </div>
                        </div>
                      </>
                    ) : (
                      <p className="text-sm text-muted-foreground">
                        Record or upload a video to begin road object detection
                      </p>
                    )}
                  </div>
                </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Road Video Detection Tips</CardTitle>
        </CardHeader>
        <CardContent>
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>The system can track objects across video frames for better analysis</li>
          </ul>
        </CardContent>
      </Card>
    </div>
